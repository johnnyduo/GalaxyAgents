...
function createSlide04_Solution_TH(presentation) {
  ...
  addTextBox(slide, '✓ ออกแบบเพื่อคนไทย  |  ✓ ตรวจจับ Real-time  |  ✓ จำลองสถานการณ์  |  ✓ AI ดูแล 24/7', 40, 365, 640, 25, {
    fontFamily: PITCH_CONFIG_TH.FONTS.BODY,
    fontSize: 12,
    color: PITCH_CONFIG_TH.COLORS.NEON_GREEN,
    align: 'center'
...
function createSlide05_KeyFeatures_TH(presentation) {
  ...
  const features = [
    {
      title: 'ตรวจจับโกง Real-time',
      desc: 'AI วิเคราะห์ SMS, สาย, URL, QR Code ในเสี้ยววินาที จับคู่กับรูปแบบการโกง 10,000+ แบบ',
      icon: '⚡',
      color: PITCH_CONFIG_TH.COLORS.NEON_GREEN
    },
    {
      title: 'จำลองสถานการณ์โกง',
      desc: '10 สถานการณ์สมจริง สอนผู้ใช้ให้รู้ทันมิจฉาชีพ ระบบแปลงร่าง Agent ชั่วร้ายโชว์กลโกง',
      icon: '🎮',
      color: PITCH_CONFIG_TH.COLORS.DANGER_RED
    },
    {
      title: 'AI Guardian 24/7 (น้องฟ้า)',
      desc: 'ผู้ช่วยส่วนตัว ตอบคำถาม ตรวจ SMS ต้องสงสัย แนะนำวิธีรับมือกับมิจฉาชีพ',
      icon: '🛡️',
...
function createSlide14_ValueProposition_TH(presentation) {
  ...
  const userValues = [
    '⚡ ป้องกัน SMS/URL/QR แบบ Real-time',
    '🎮 เรียนรู้กลโกงผ่านการจำลอง',
    '🇹🇭 ออกแบบเพื่อคนไทยโดยเฉพาะ',
    '🤖 AI Guardian 24/7 (น้องฟ้า)',
    '👨‍👩‍👧 ฟีเจอร์ปกป้องครอบครัว',
    '📱 ไม่ต้องมีทักษะทางเทคนิค'
  ];
...
function createSlide16_Competitive_TH(presentation) {
  ...
  const moats = [
    ...
    { title: 'Unique Simulation', desc: 'ไม่มีคู่แข่งทำแบบนี้', icon: '🎮' },
